...
This adapter is used for attaching to labware movers
such as the movable tray. The snap fit pegs on each
leg will snap into the adapter holes on these parts.
The adapter works by acting as a row of p200 tips,
allowing the entire assembly to be lifted and moved by
the multichannel pipette.
